<x-app-layout>
    ...
    <div class="card">
        ...
        <form action="{{ route('venta.saveExcelCambio') }}" method="POST" enctype="multipart/form-data" role="form">
            @csrf
            <div class="card-body">
            ...
            <div class="card-footer d-flex justify-content-end">
                <button type="submit" class="btn bg-ibizza">Cargar Cambios</button>
            </div>
        </form>
