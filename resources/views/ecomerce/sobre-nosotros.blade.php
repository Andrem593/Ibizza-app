                ...
                <div class="col-12">
                    <div class="row ec_breadcrumb_inner">
                        <div class="col-md-6 col-sm-12">
                            <h2 class="ec-breadcrumb-title">Sobre Nosotros</h2>
                        </div>
                        <div class="col-md-6 col-sm-12">
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <div class="section-title">
                        <h2 class="ec-bg-title">Sobre Nosotros</h2>
                        <h2 class="ec-title">Sobre Nosotros</h2>
                        <p class="sub-title mb-3">Acerca de nuestra empresa comercial</p>
                    </div>
                </div>
