<x-app-layout>
    ...
    <x-slot name="header">
        <h5 class="text-center">Parámetros de Costo de Envío</h5>
    </x-slot>
        ...
        <div class="card-header">
            <div style="display: flex; justify-content: space-between; align-items: center;">
                ...
                <div class="float-right">
                    <a href="{{ route('catalogo.reglas') }}" class="btn btn-ibizza btn-sm float-right"
                        data-placement="left">
                        {{ __('Nueva Regla') }}
                    </a>
                </div>
    ...
    @Push('scripts')
        ...
        <script>
            $(document).ready(function() {
                ...
                let ruta = '/catalogo/parametros/listar'
                crearTablaPCatalogo(data, ruta);
            });
        </script>
    @endpush
