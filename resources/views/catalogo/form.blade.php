    ...
    <div class="box-body">
        ...
        <div class="row">
            ...
            <div class="col">
                ...
                <x-adminlte-input-file name="pdf_path" class=""
                    igroup-size="sm" label="Carga archivo (.pdf)" legend="Seleccionar" placeholder="Escoger un archivo .pdf" accept="application/pdf">
