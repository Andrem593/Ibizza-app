                        ...
                        <div class="banner-block col-sm-12 {{$catalogos->count() > 1 ? 'col-md-6': 'col-md-12'}}"
                            ...
                            <div class="bnr-overlay">
                                ...
                                <div class="banner-content">
                                    <span class="ec-banner-btn"><a class="btn-modal" data-bs-toggle="modal"
                                            data-bs-target="#modalCustom">Ver
                                            Catálogo</a></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row g-0">
                            <div class="col-md-5 my-auto">
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Debes acceder con tu usuario en Soy Empresaria y podras
                                        solicitar tu catálogo fisico o descargar el catálogo virtual, podras saber tus
                                        ganancias, tus ultimos pedidos, tus premios y mucho más.</p>
                                    @auth
                                    <a href="{{ route('web.perfil-empresaria') }}" class="btn nav-link">Soy
                                        Empresaria</a>
                                    @else
                ...
                <div class="ec-brand-outer">
                    <ul id="ec-brand-slider">
                        ...
                        <li class="ec-brand-item" data-animation="zoomIn">
                            <div class="ec-brand-img"><a href="/tienda/marca/{{ $marca->nombre }}"><img loading='lazy'
                                        alt="brand" title="brand" src="storage/images/marca/{{ $marca->imagen }}" /></a>
                            </div>
                        </li>
                        @endforeach
                    </ul>
