									...
									<div style="border: 0px solid transparent; padding: 30px;"> <table width="100%" cellspacing="0" cellpadding="0" border="0"><tbody><tr><td style="padding-right: 0px; padding-left: 0px; padding-top: 0px; padding-bottom: 15px; font-family: Tahoma, sans-serif">
										<div style="color: #ffffff; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; line-height: 1.5; padding: 0px 0px 30px 0px;">
											<div style="line-height: 1.5; font-size: 12px; color: #ffffff; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; mso-line-height-alt: 18px;">
												<p style="font-size: 18px; line-height: 1.5; word-break: break-word; text-align: center; mso-line-height-alt: 27px; margin: 0;"><span style="font-size: 30px;"><strong>Hola</strong>. </span><br><br><span style="font-size: 17px; ">Un nuevo contacto envi&oacute; una consulta con la siguiente informaci&oacute;n:</p>
											</div>
										</div>
									</td></tr></tbody></table>
                                        ...
                                        <div style="background: #fff">
                                            <table style="padding: 10px">
                                                <tbody style="line-height: 1.5; font-size: 18px; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; mso-line-height-alt: 18px;">
                                                    <tr><td><span style="font-weight: bold">Nombre:</span> {{$name}}</td></tr>
                                                    <tr><td><span style="font-weight: bold">Correo:</span> {{$email}}</td></tr>
                                                    <tr><td><span style="font-weight: bold">Tel&eacute;fono:</span> {{$phonenumber}}</td></tr>
                                                    <tr><td><span style="font-weight: bold">Comentarios/Preguntas:</span> {{$comments}}</td></tr>
                                                </tbody>
                                            </table>
                                        </div>
									</div>
