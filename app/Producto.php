...
class Producto extends Model
{
     ...
     * @var array
     */
    protected $fillable = ['sku', 'nombre_producto', 'descripcion', 'marca_id', 'seccion', 'clasificacion', 'proveedor_id', 'estilo', 'color', 'talla', 'cantidad_inicial', 'stock', 'valor_venta', 'ultima_venta', 'estado'];
